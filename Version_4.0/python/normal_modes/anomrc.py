...
def anomrc(args=None):
    ...
    parser = argparse.ArgumentParser(
        ...
        "Usage:\n"
        "  anomrc  [caso] [epoca] [csst] [lev] [magwind]\n\n"
        "Default:\n"
    ...
    filec='UVHSERA_5'+csstc+csdc.datei+csdc.datef+'P.icn.'+trunc+'_'+exta+'.ctl'
    filed='UVHSERA_5'+csstc+csdc.datei+csdc.datef+'P.icn.'+trunc+'_'+extb+'.ctl'
    ...
    exp_name=''
    fileg=VDout+'/'+filec
    v3r = down.open_grads(fileg,exp_name)
    v3  = v3r.sel(lev=lev) 
    ...
    if (cx=='RS'):
        ...
        hcl=v3.hrb+v4.hkv+v4.hmx
        ucl=v3.urb+v4.ukv+v4.umx
        vcl=v3.vrb+v4.vkv+v4.vmx
